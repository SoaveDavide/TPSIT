...
{   //creazione di un elemento di tipo sockaddr vedi pagina 162
    ...
    char c; //carattere da inviare
    int n; //numero di occorrenze
    ...
    write(socketfd,str1,sizeof(str1));// invia stringa
    write(socketfd, &c, sizeof(c)); //invia carattere
    
    read(socketfd, &n, sizeof(n));//legge le occorrenze
